...
int main() {
    ...
    // Chamar planejador:
    system("/tmp/dir/software/planners/downward/fast-downward.py --alias seq-opt-fdss-2 --overall-time-limit 800 --plan-file plan.pddl domain.pddl problem.pddl > /dev/null 2>&1");
    remove("domain.pddl");
    remove("problem.pddl");
