...
int main() {
    ...
    // Chamar planejador:
    system("/home/software/planners/downward-fdss23/fast-downward.py --alias seq-opt-fdss-2023 --overall-time-limit 850 --plan-file plan.pddl domain.pddl problem.pddl > /dev/null 2>&1");
